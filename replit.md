...
- **Marketplace**: Buy/sell platform for agricultural products (Onion Seedlings, Potato Seeds). Category-specific fields, photo upload, GPS-based distance sorting, seller location display, and contact info visible only to logged-in users. Color-coded cards per category.
...
-   **UI/UX**: Responsive design with a desktop sidebar and mobile bottom navigation. Color-coded event types for visual clarity (e.g., Plantation - green, Fertiliser - amber).
